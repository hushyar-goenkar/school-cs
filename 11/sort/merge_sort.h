...
/**
 * a = First array
 * nA = Size of first array
 * b = Second array
 * nB = Size of second array
 * c = Third array pointer to place the final sorted array in
 */
 ...
 * offset = The index of the element from where the array is to be sorted. eg: offset = 1 means that all elements from index 1 till the end will be sorted
 * nA = size of array a
 * c = Pointer to the final array where the sorted array will be placed. Size = nA - offset.
 */
